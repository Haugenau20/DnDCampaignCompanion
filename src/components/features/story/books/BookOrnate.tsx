...
const BookOrnate: React.FC<BookProps> = ({ height, className }) => {
  return (
    ...
    >
        ...
        <rect x="10" y="10" width="40" height="130" fill="none" stroke="#D4AF37" strokeWidth="0.5" />
        ...
        <circle cx="30" cy="75" r="20" fill="#5E1914" stroke="#D4AF37" strokeWidth="1" />
        <path d="M30 55 L30 95 M20 65 L40 85 M40 65 L20 85" stroke="#D4AF37" strokeWidth="1" fill="none" />
        <circle cx="30" cy="75" r="10" fill="#5E1914" stroke="#D4AF37" strokeWidth="0.5" />
        ...
        {/* Ornate swirls */}
        <path d="M15 40 Q30 35, 45 40" stroke="#D4AF37" strokeWidth="1" fill="none" />
        <path d="M15 45 Q30 50, 45 45" stroke="#D4AF37" strokeWidth="1" fill="none" />
        <path d="M15 105 Q30 100, 45 105" stroke="#D4AF37" strokeWidth="1" fill="none" />
        <path d="M15 110 Q30 115, 45 110" stroke="#D4AF37" strokeWidth="1" fill="none" />
        ...
        <defs>
            ...
            <path d="M5 0 L10 5 L15 0 M0 5 L5 10 L0 15 M20 5 L15 10 L20 15 M5 20 L10 15 L15 20" stroke="#D4AF37" strokeWidth="0.3" fill="none" />
