 ...
 * campaign is what this page has instead of a trail. It is `BackToCampaign`
 * rather than this file's own button: profile wrote the same control, with the
 * same fallback label, a second time.
 *
