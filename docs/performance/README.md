...
Which findings are still open, and what is tracked against them, lives in [`TODO.md`](../../TODO.md) under **Performance** — entries `T029`–`T033`, plus `T023` (`PERF-08`) and `T024` (`PERF-15`). This directory stays the record of the audit and its evidence; it is not updated as findings close.
